...
-- Visual Block --
-- Move text up and down
maps.v["J"] = { ":move '>+1<CR>gv-gv", desc = "" }
maps.v["K"] = { ":move '<-2<CR>gv-gv", desc = "" }
maps.v["<A-j>"] = { ":move '>+1<CR>gv-gv", desc = "" }
maps.v["<A-Down>"] = { ":move '>+1<CR>gv-gv", desc = "" }
maps.v["<A-k>"] = { ":move '<-2<CR>gv-gv", desc = "" }
maps.v["<A-Up>"] = { ":move '<-2<CR>gv-gv", desc = "" }

maps.n["<S-Down>"] = { "<cmd>t.<cr>", desc = "" }
maps.i["<S-Down>"] = { "<cmd>t.<cr>", desc = "" }
maps.n["<S-Up>"] = { "<cmd>t -1<cr>", desc = "" }
maps.i["<S-Up>"] = { "<cmd>t -1<cr>", desc = "" }
maps.n["<M-J>"] = { "<cmd>t.<cr>", desc = "" }
maps.n["<M-K>"] = { "<cmd>t -1<cr>", desc = "" }
maps.n["<M-Down>"] = { "<cmd>m+<cr>", desc = "" }
maps.i["<M-Down>"] = { "<cmd>m+<cr>", desc = "" }
maps.n["<M-Up>"] = { "<cmd>m-2<cr>", desc = "" }
maps.i["<M-Up>"] = { "<cmd>m-2<cr>", desc = "" }
maps.n["<M-j>"] = { "<cmd>m+<cr>", desc = "" }
...
maps.n["<leader>ub"] = {
  function()
    astronvim.ui.toggle_background()
  end,
...
maps.n["<leader>uN"] = {
  function()
    astronvim.ui.toggle_ui_notifications()
  end,
